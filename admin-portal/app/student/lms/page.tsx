    ...
    <div className="p-4 md:p-6 space-y-5 max-w-4xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-12 text-center">
          ...
          <p className="text-slate-500 font-medium">No courses for this period.</p>
          <p className="text-slate-400 text-sm mt-1">Try a different year or semester, or check with your teachers.</p>
        </div>
      ) : (
              ...
              <div className="p-4 flex-1 flex flex-col">
                <div className="flex items-start justify-between gap-2 mb-1">
                  ...
                  {course.pending_assignments > 0 && (
                    <span className="shrink-0 text-xs font-bold text-white px-2 py-0.5 rounded-full" style={{ background: '#B83232' }}>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="text-xs font-semibold px-2.5 py-1 rounded-full" style={{ color: '#8C7E6E', background: '#8C7E6E18' }}>
                    {course.lesson_count} Lessons
                  </span>
                  <span className="text-xs font-semibold px-2.5 py-1 rounded-full" style={{ color: '#C8780A', background: '#C8780A18' }}>
                ...
                <button
                  ...
                  className="mt-auto w-full py-2 rounded-lg text-sm font-semibold text-white transition-colors"
