...
const styles = StyleSheet.create({
  ...
  empty:       { backgroundColor: '#FAFAF8', borderRadius: 16, borderWidth: 1, borderColor: '#E2D9CC', padding: 40, alignItems: 'center' },
  emptyIcon:   { fontSize: 36, marginBottom: 10 },
  emptyTitle:  { fontSize: 15, fontWeight: '700', color: '#2C2218' },
  emptySub:    { fontSize: 13, color: '#8C7E6E', marginTop: 4, textAlign: 'center' },
  card:        { backgroundColor: '#FAFAF8', borderRadius: 16, borderWidth: 1, borderColor: '#E2D9CC', padding: 14, marginBottom: 10 },
  cardBody:    { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  flex1:       { flex: 1 },
  titleRow:    { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 },
  dot:         { width: 8, height: 8, borderRadius: 4, backgroundColor: '#B83232', flexShrink: 0 },
