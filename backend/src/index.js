...
const principalDisciplineRoutes = require('./routes/principal-discipline');
const principalGeneralLettersRoutes = require('./routes/principal-general-letters');
...
app.use('/api/principal/discipline',      principalDisciplineRoutes);
app.use('/api/principal/general-letters', principalGeneralLettersRoutes);
...
async function runMigrations() {
  ...
  try {
    ...
    // these tables from being created on the next restart.
    try {
      await pool.query(`
