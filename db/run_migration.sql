-- =============================================================
-- CAS — Full Multi-Tenant Migration
-- Run this in Supabase SQL Editor (paste the whole file, then click Run)
-- Safe because all tables are currently empty.
-- =============================================================
